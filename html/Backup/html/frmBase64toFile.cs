    ...
    public partial class frmBase64toFile : Form
    {
        ...
        void bgwDecrypt_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                Byte[] bytes = Convert.FromBase64String(yourBase64String.Replace(@"\n", ""));
        ...
        private void btnDecryptGenerate_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(this.txtDecryptFile.Text)) return;
        ...
        {
            Button btn = sender as Button;
            if (string.IsNullOrEmpty(this.txtEncryptFile.Text)) return;
