...
namespace UtilETWeb
{
	public partial class frmGenerateSpPaging: Form
	{
		public frmGenerateSpPaging() {
			InitializeComponent();
		}
		...
		private void btnGenerar_Click(object sender, EventArgs e) {
			...
			string fileName = Path.Combine("Scripts", string.Format("001-[script sp paginate {0}].sql", this.txtAliasTableName.Text));

			string script = Properties.Resources._0001__sp_Alias_list_pag_;
