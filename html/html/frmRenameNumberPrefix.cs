...
namespace UtilETWeb
{
	public partial class frmRenameNumberPrefix: Form
	{
		public frmRenameNumberPrefix() {
			InitializeComponent();
			this.Load += FrmRenameNumberPrefix_Load;
		}

		private void FrmRenameNumberPrefix_Load(object sender, EventArgs e) {
		...
		private void button1_Click(object sender, EventArgs e) {
			...
			string[] filesNames = Directory.GetFiles(this.textBox1.Text);
			if (filesNames.Length > 0) {
				List<string> pathfiles = filesNames.CustomSort().ToList();
