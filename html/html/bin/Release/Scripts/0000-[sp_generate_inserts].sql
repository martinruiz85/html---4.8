/****** Object:  StoredProcedure [dbo].[sp_generate_inserts]    Script Date: 02/28/2018 11:26:42 ******/
...
WHILE @Column_ID IS NOT NULL          
 BEGIN          
  ...
  TABLE_NAME = @table_name AND          (@owner IS NULL OR TABLE_SCHEMA = @owner)          
...
--  PRINT 'GO' --Se comentarizo para que pueda correr sp en c#          
  PRINT ''          
 END          
