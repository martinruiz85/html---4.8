...
namespace UtilETWeb
{
	public partial class frmReportNodes: Form
	{
		...
		void frmReportNodes_Load(object sender, EventArgs e) {
			string html = File.ReadAllText(@"C:\Users\Consultorin\Documents\Visual Studio 2005\Projects\Report Project2\Report Project2\Resumen360ProgramaEval.back1.rdl");
